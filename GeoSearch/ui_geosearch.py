...
class Ui_GeoSearch(object):
    def setupUi(self, GeoSearch):
        ...
        self.SearchByAddr_pushButton.setGeometry(QtCore.QRect(440, 40, 81, 23))
        ...
        self.SearchByPt_pushButton.setGeometry(QtCore.QRect(470, 90, 71, 23))
        ...
        self.Result_List_label.setGeometry(QtCore.QRect(10, 10, 171, 16))
        self.Result_List_label.setObjectName(_fromUtf8("Result_List_label"))
        self.Result_listWidget = QtGui.QListWidget(self.tab)
        self.Result_listWidget.setGeometry(QtCore.QRect(10, 31, 481, 201))
        ...
        self.Result_textEdit.setGeometry(QtCore.QRect(10, 30, 481, 191))
        ...
        self.GoToGetCoordinateFromMapCanvasMode_pushButton = QtGui.QPushButton(GeoSearch)
        self.GoToGetCoordinateFromMapCanvasMode_pushButton.setGeometry(QtCore.QRect(390, 90, 71, 23))
        self.GoToGetCoordinateFromMapCanvasMode_pushButton.setObjectName(_fromUtf8("GoToGetCoordinateFromMapCanvasMode_pushButton"))
    ...
    def retranslateUi(self, GeoSearch):
        ...
        self.GoToGetCoordinateFromMapCanvasMode_pushButton.setText(QtGui.QApplication.translate("GeoSearch", "From Map...", None, QtGui.QApplication.UnicodeUTF8))
