...
class Ui_GeoSearch(object):
    def setupUi(self, GeoSearch):
        ...
        self.TurnOnGeosearchLayer_checkBox = QtGui.QCheckBox(self.Pt_tab)
        self.TurnOnGeosearchLayer_checkBox.setGeometry(QtCore.QRect(20, 110, 141, 17))
        self.TurnOnGeosearchLayer_checkBox.setChecked(True)
        self.TurnOnGeosearchLayer_checkBox.setObjectName(_fromUtf8("TurnOnGeosearchLayer_checkBox"))
        self.AppendResults_checkBox = QtGui.QCheckBox(self.Pt_tab)
        self.AppendResults_checkBox.setEnabled(True)
        self.AppendResults_checkBox.setGeometry(QtCore.QRect(20, 130, 141, 17))
        self.AppendResults_checkBox.setChecked(False)
        self.AppendResults_checkBox.setObjectName(_fromUtf8("AppendResults_checkBox"))
        ...
        GeoSearch.setTabOrder(self.SearchOnGoogleWebMap_checkBox, self.TurnOnGeosearchLayer_checkBox)
        GeoSearch.setTabOrder(self.TurnOnGeosearchLayer_checkBox, self.AppendResults_checkBox)
        GeoSearch.setTabOrder(self.AppendResults_checkBox, self.Result_tabWidget)
        GeoSearch.setTabOrder(self.Result_tabWidget, self.Result_listWidget)
        GeoSearch.setTabOrder(self.Result_listWidget, self.DistFomula_comboBox)
        ...
        GeoSearch.setTabOrder(self.SearchRoute_pushButton, self.FeatureOption_tabWidget)
        GeoSearch.setTabOrder(self.FeatureOption_tabWidget, self.Result_textEdit)
    ...
    def retranslateUi(self, GeoSearch):
        ...
        self.TurnOnGeosearchLayer_checkBox.setText(_translate("GeoSearch", "Turn On Geosearch layer", None))
        self.AppendResults_checkBox.setText(_translate("GeoSearch", "Append results", None))
